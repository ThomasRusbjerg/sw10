#source: https://github.com/OMR-Research/MungLinker/blob/master/munglinker/evaluate_notation_assembly_from_mung.py
"""
...
def evaluate_result(reference_objects, predicted_objects):
