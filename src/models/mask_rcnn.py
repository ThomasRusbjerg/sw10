...
from models.rcnn.layers.detection_target import DetectionTargetLayer
from models.rcnn.layers.utils import norm_boxes_graph
from models.rcnn.data_format import (
    mold_image,
    parse_image_meta_graph,
    compose_image_meta,
)
from models.rcnn.anchors import generate_pyramid_anchors
from models.rcnn.bbox import norm_boxes, denorm_boxes
from models.rcnn.fpn import fpn_classifier_graph, build_fpn_mask_graph
...
class MaskRCNN(object):
    ...
    def compile(self, learning_rate, momentum):
        ...
        for name in loss_names:
            ...
            self.keras_model.add_loss(loss, name)
