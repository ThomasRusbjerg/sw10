...
from models.rcnn.bbox import box_refinement_graph
from models.rcnn.layers.utils import batch_slice
...
def detection_targets_graph(proposals, gt_class_ids, gt_boxes, gt_masks, config):
    ...
    asserts = [
        tf.Assert(
            tf.greater(tf.shape(input=proposals)[0], 0), [proposals], name="roi_assertion"
        ),
    ]
