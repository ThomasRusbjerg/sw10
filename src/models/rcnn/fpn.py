...
from models.rcnn.layers.roi_align import PyramidROIAlign
from models.backbones.utils import BatchNorm
...
def fpn_classifier_graph(
    ...
    shared = KL.Lambda(lambda x: squeeze(squeeze(x, 3), 2), name="pool_squeeze")(x)
